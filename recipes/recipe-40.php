...
<div class="recipe-container">
    <img class="recipe-img" src="../images/dal_makhani.jpg" alt="Dal Makhani" onerror="this.onerror=null;this.src='../assets/default_recipe.jpg';">
    <h1>Dal Makhani</h1>
    <h3>Ingredients:</h3>
    <p>urad dal, rajma, cream, butter, spice</p>
    <h3>Steps:</h3>
    <ol style="text-align:left;max-width:380px;margin:0 auto 10px auto;padding-left:1.2em;">
        <li>Soak urad dal and rajma overnight.</li>
        <li>Pressure cook until soft.</li>
        <li>Heat butter, sauté onions and tomatoes.</li>
        <li>Add spices and cook well.</li>
        <li>Add cooked dal and simmer on low flame for 1 hour.</li>
        <li>Stir occasionally and add cream.</li>
    ...
    <a href="https://www.youtube.com/results?search_query=Dal+Makhani+recipe" target="_blank" style="display:inline-block;margin-top:18px;padding:10px 22px;background:linear-gradient(90deg,#f76b1c,#fda085);color:#fff;border:none;border-radius:6px;font-size:1rem;font-weight:bold;text-decoration:none;box-shadow:0 2px 8px #fda08533;transition:background 0.2s,transform 0.2s;">▶ Watch on YouTube</a>
</div>
