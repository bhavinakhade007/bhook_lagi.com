...
<div class="recipe-container">
    <img class="recipe-img" src="../images/matar_paneer.jpg" alt="Matar Paneer" onerror="this.onerror=null;this.src='../assets/default_recipe.jpg';">
    <h1>Matar Paneer</h1>
    <h3>Ingredients:</h3>
    <p>paneer, peas, onion, tomato, spice</p>
    <h3>Steps:</h3>
    <ol style="text-align:left;max-width:380px;margin:0 auto 10px auto;padding-left:1.2em;">
        ...
        <li>Add boiled peas and paneer cubes.</li>
        <li>Add water and simmer 10 minutes.</li>
    ...
    <a href="https://www.youtube.com/results?search_query=Matar+Paneer+recipe" target="_blank" style="display:inline-block;margin-top:18px;padding:10px 22px;background:linear-gradient(90deg,#f76b1c,#fda085);color:#fff;border:none;border-radius:6px;font-size:1rem;font-weight:bold;text-decoration:none;box-shadow:0 2px 8px #fda08533;transition:background 0.2s,transform 0.2s;">▶ Watch on YouTube</a>
</div>
