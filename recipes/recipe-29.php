...
<div class="recipe-container">
    <img class="recipe-img" src="../images/handvo.jpg" alt="Handvo" onerror="this.onerror=null;this.src='../assets/default_recipe.jpg';">
    <h1>Handvo</h1>
    <h3>Ingredients:</h3>
    <p>rice, dal, bottle gourd, spice</p>
    <h3>Steps:</h3>
    <ol style="text-align:left;max-width:380px;margin:0 auto 10px auto;padding-left:1.2em;">
        <li>Soak rice and dal overnight.</li>
        <li>Grind into coarse batter.</li>
        <li>Mix with grated bottle gourd and spices.</li>
        <li>Ferment overnight.</li>
        <li>Heat oil, add sesame seeds and curry leaves.</li>
        <li>Pour batter into greased pan.</li>
        <li>Cook on low flame or bake until crisp outside.</li>
    ...
    <a href="../spin.php" style="display:inline-block;margin-top:18px;margin-left:8px;padding:10px 18px;background:#6c63ff;color:#fff;border:none;border-radius:6px;font-size:0.95rem;font-weight:700;text-decoration:none;box-shadow:0 2px 8px #6c63ff55;">Can't decide?</a>
        <a href="https://www.youtube.com/results?search_query=Handvo+recipe" target="_blank" style="display:inline-block;margin-top:18px;padding:10px 22px;background:linear-gradient(90deg,#f76b1c,#fda085);color:#fff;border:none;border-radius:6px;font-size:1rem;font-weight:bold;text-decoration:none;box-shadow:0 2px 8px #fda08533;transition:background 0.2s,transform 0.2s;">▶ Watch on YouTube</a>
</div>
