...
<div class="recipe-container">
    <img class="recipe-img" src="../images/khichdi.jpg" alt="Khichdi" onerror="this.onerror=null;this.src='../assets/default_recipe.jpg';">
    <h1>Khichdi</h1>
    <h3>Ingredients:</h3>
    <p>rice, dal, ghee, spice</p>
    <h3>Steps:</h3>
    <ol style="text-align:left;max-width:380px;margin:0 auto 10px auto;padding-left:1.2em;">
        <li>Wash rice and dal.</li>
        <li>Heat ghee, add cumin seeds.</li>
        <li>Add rice and dal.</li>
        <li>Add turmeric, salt, and water.</li>
        <li>Cook until soft.</li>
        <li>Mash lightly.</li>
        <li>Serve with ghee and pickle.</li>
    </ol>
    ...
    <a href="https://www.youtube.com/results?search_query=Khichdi+recipe" target="_blank" style="display:inline-block;margin-top:18px;padding:10px 22px;background:linear-gradient(90deg,#f76b1c,#fda085);color:#fff;border:none;border-radius:6px;font-size:1rem;font-weight:bold;text-decoration:none;box-shadow:0 2px 8px #fda08533;transition:background 0.2s,transform 0.2s;">▶ Watch on YouTube</a>
</div>
