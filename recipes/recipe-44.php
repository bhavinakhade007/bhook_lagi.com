...
<div class="recipe-container">
    <img class="recipe-img" src="../images/momos.jpg" alt="Momos" onerror="this.onerror=null;this.src='../assets/default_recipe.jpg';">
    <h1>Momos</h1>
    <h3>Ingredients:</h3>
    <p>flour, cabbage, carrot, spice</p>
    <h3>Steps:</h3>
    <ol style="text-align:left;max-width:380px;margin:0 auto 10px auto;padding-left:1.2em;">
        <li>Knead flour to make dough.</li>
        <li>Chop vegetables and mix with spices.</li>
        <li>Roll dough and fill with vegetable mixture.</li>
        <li>Shape momos and steam until cooked.</li>
    ...
    <a href="https://www.youtube.com/results?search_query=Momos+recipe" target="_blank" style="display:inline-block;margin-top:18px;padding:10px 22px;background:linear-gradient(90deg,#f76b1c,#fda085);color:#fff;border:none;border-radius:6px;font-size:1rem;font-weight:bold;text-decoration:none;box-shadow:0 2px 8px #fda08533;transition:background 0.2s,transform 0.2s;">▶ Watch on YouTube</a>
</div>
