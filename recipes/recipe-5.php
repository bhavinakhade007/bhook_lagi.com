...
<div class="recipe-container">
    <img class="recipe-img" src="../images/samosa.jpg" alt="Samosa" onerror="this.onerror=null;this.src='../assets/default_recipe.jpg';">
    <h1>Samosa</h1>
    <h3>Ingredients:</h3>
    <p>potato, peas, flour, spice</p>
    <h3>Steps:</h3>
    <ol style="text-align:left;max-width:380px;margin:0 auto 10px auto;padding-left:1.2em;">
        <li>Knead flour with oil and salt to form stiff dough.</li>
        <li>Rest dough for 30 minutes.</li>
        <li>Boil potatoes and peas, mash together.</li>
        <li>Heat oil, sauté cumin, ginger, green chili, and spices.</li>
        <li>Add potato-pea mix, cook for 5 minutes.</li>
        <li>Roll dough into circles, cut in half.</li>
        <li>Make cone shape, stuff filling inside.</li>
        <li>Seal edges with water.</li>
        <li>Heat oil and deep fry samosas on low flame until golden.</li>
    ...
    <a href="https://www.youtube.com/results?search_query=Samosa+recipe" target="_blank" style="display:inline-block;margin-top:18px;padding:10px 22px;background:linear-gradient(90deg,#f76b1c,#fda085);color:#fff;border:none;border-radius:6px;font-size:1rem;font-weight:bold;text-decoration:none;box-shadow:0 2px 8px #fda08533;transition:background 0.2s,transform 0.2s;">▶ Watch on YouTube</a>
</div>
