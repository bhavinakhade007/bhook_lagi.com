...
<div class="recipe-container">
    <img class="recipe-img" src="../images/malai_kofta.jpg" alt="Malai Kofta" onerror="this.onerror=null;this.src='../assets/default_recipe.jpg';">
    <h1>Malai Kofta</h1>
    <h3>Ingredients:</h3>
    <p>paneer, potato, cream, tomato, spice</p>
    <h3>Steps:</h3>
    <ol style="text-align:left;max-width:380px;margin:0 auto 10px auto;padding-left:1.2em;">
        <li>Mash paneer and potato, add spices.</li>
        <li>Shape into balls, stuff with nuts if desired.</li>
        <li>Deep fry until golden.</li>
        <li>Heat oil, sauté onions and tomatoes.</li>
        <li>Grind into smooth paste.</li>
        <li>Cook paste with cream and spices.</li>
        <li>Add koftas before serving.</li>
        <li>Garnish with cream.</li>
    ...
    <a href="https://www.youtube.com/results?search_query=Malai+Kofta+recipe" target="_blank" style="display:inline-block;margin-top:18px;padding:10px 22px;background:linear-gradient(90deg,#f76b1c,#fda085);color:#fff;border:none;border-radius:6px;font-size:1rem;font-weight:bold;text-decoration:none;box-shadow:0 2px 8px #fda08533;transition:background 0.2s,transform 0.2s;">▶ Watch on YouTube</a>
</div>
