...
<div class="recipe-container">
    <img class="recipe-img" src="../images/shahi_paneer.jpg" alt="Shahi Paneer" onerror="this.onerror=null;this.src='../assets/default_recipe.jpg';">
    <h1>Shahi Paneer</h1>
    <h3>Ingredients:</h3>
    <p>paneer, cashew, tomato, cream, spice</p>
    <h3>Steps:</h3>
    <ol style="text-align:left;max-width:380px;margin:0 auto 10px auto;padding-left:1.2em;">
        <li>Soak cashews and grind to paste.</li>
        <li>Heat oil, sauté onions and tomatoes.</li>
        <li>Blend into paste.</li>
        <li>Heat ghee, add spices.</li>
        <li>Add cashew paste and onion-tomato paste.</li>
        <li>Cook until oil separates.</li>
        <li>Add cream and paneer cubes.</li>
        <li>Simmer gently.</li>
    ...
    <a href="https://www.youtube.com/results?search_query=Shahi+Paneer+recipe" target="_blank" style="display:inline-block;margin-top:18px;padding:10px 22px;background:linear-gradient(90deg,#f76b1c,#fda085);color:#fff;border:none;border-radius:6px;font-size:1rem;font-weight:bold;text-decoration:none;box-shadow:0 2px 8px #fda08533;transition:background 0.2s,transform 0.2s;">▶ Watch on YouTube</a>
</div>
