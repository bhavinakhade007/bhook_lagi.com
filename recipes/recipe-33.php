...
<div class="recipe-container">
    <img class="recipe-img" src="../images/upma.jpg" alt="Upma" onerror="this.onerror=null;this.src='../assets/default_recipe.jpg';">
    <h1>Upma</h1>
    <h3>Ingredients:</h3>
    <p>rava, onion, curry leaves, spice</p>
    <h3>Steps:</h3>
    <ol style="text-align:left;max-width:380px;margin:0 auto 10px auto;padding-left:1.2em;">
        <li>Roast rava until fragrant.</li>
        <li>Heat oil, add mustard seeds, curry leaves, chilies.</li>
        <li>Add onions and sauté.</li>
        <li>Add water and salt, bring to boil.</li>
        <li>Add roasted rava slowly while stirring.</li>
        <li>Cook until fluffy.</li>
    ...
    <a href="https://www.youtube.com/results?search_query=Upma+recipe" target="_blank" style="display:inline-block;margin-top:18px;padding:10px 22px;background:linear-gradient(90deg,#f76b1c,#fda085);color:#fff;border:none;border-radius:6px;font-size:1rem;font-weight:bold;text-decoration:none;box-shadow:0 2px 8px #fda08533;transition:background 0.2s,transform 0.2s;">▶ Watch on YouTube</a>
</div>
