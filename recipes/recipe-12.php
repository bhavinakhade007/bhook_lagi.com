...
<div class="recipe-container">
    <img class="recipe-img" src="../images/rajma_chawal.jpg" alt="Rajma Chawal" onerror="this.onerror=null;this.src='../assets/default_recipe.jpg';">
    <h1>Rajma Chawal</h1>
    <h3>Ingredients:</h3>
    <p>rajma, rice, onion, tomato, spice</p>
    <h3>Steps:</h3>
    <ol style="text-align:left;max-width:380px;margin:0 auto 10px auto;padding-left:1.2em;">
        <li>Soak rajma overnight.</li>
        <li>Pressure cook rajma until soft.</li>
        <li>Heat oil, add onions and sauté until golden.</li>
        <li>Add ginger-garlic paste and tomatoes.</li>
        <li>Add spices and cook masala until oil separates.</li>
        <li>Add cooked rajma and simmer 20 minutes.</li>
        <li>Boil rice separately.</li>
        <li>Serve rajma curry with steamed rice.</li>
    </ol>
    ...
    <a href="https://www.youtube.com/results?search_query=Rajma+Chawal+recipe" target="_blank" style="display:inline-block;margin-top:18px;padding:10px 22px;background:linear-gradient(90deg,#f76b1c,#fda085);color:#fff;border:none;border-radius:6px;font-size:1rem;font-weight:bold;text-decoration:none;box-shadow:0 2px 8px #fda08533;transition:background 0.2s,transform 0.2s;">▶ Watch on YouTube</a>
</div>
