...
<div class="recipe-container">
    <img class="recipe-img" src="../images/dhokla.jpg" alt="Dhokla" onerror="this.onerror=null;this.src='../assets/default_recipe.jpg';">
    <h1>Dhokla</h1>
    <h3>Ingredients:</h3>
    <p>besan, curd, eno, spice</p>
    <h3>Steps:</h3>
    <ol style="text-align:left;max-width:380px;margin:0 auto 10px auto;padding-left:1.2em;">
        <li>Mix besan, curd, salt, and water into batter.</li>
        <li>Rest for 30 minutes.</li>
        <li>Add eno before steaming.</li>
        <li>Pour batter into greased plate.</li>
        <li>Steam for 15 minutes.</li>
        <li>Cool slightly, cut into squares.</li>
        <li>Heat oil, add mustard seeds, curry leaves, and green chili.</li>
        <li>Pour tempering over dhokla.</li>
        <li>Garnish with coriander and coconut.</li>
