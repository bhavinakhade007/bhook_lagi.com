...
<div class="recipe-container">
    <img class="recipe-img" src="../images/khandvi.jpg" alt="Khandvi" onerror="this.onerror=null;this.src='../assets/default_recipe.jpg';">
    <h1>Khandvi</h1>
    <h3>Ingredients:</h3>
    <p>besan, curd, turmeric, spice</p>
    <h3>Steps:</h3>
    <ol style="text-align:left;max-width:380px;margin:0 auto 10px auto;padding-left:1.2em;">
        <li>Mix besan, curd, water, and turmeric.</li>
        <li>Cook on low flame, stirring continuously.</li>
        <li>Cook until thick but spreadable.</li>
        <li>Spread thinly on greased surface.</li>
        <li>Cool and cut strips.</li>
        <li>Roll strips tightly.</li>
        <li>Heat oil, add mustard seeds and curry leaves.</li>
        <li>Pour tempering over khandvi.</li>
        <li>Garnish with coconut and coriander.</li>
    </ol>
    ...
    <a href="https://www.youtube.com/results?search_query=Khandvi+recipe" target="_blank" style="display:inline-block;margin-top:18px;padding:10px 22px;background:linear-gradient(90deg,#f76b1c,#fda085);color:#fff;border:none;border-radius:6px;font-size:1rem;font-weight:bold;text-decoration:none;box-shadow:0 2px 8px #fda08533;transition:background 0.2s,transform 0.2s;">▶ Watch on YouTube</a>
</div>
