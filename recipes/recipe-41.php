...
<div class="recipe-container">
    <img class="recipe-img" src="../images/poha.jpg" alt="Poha" onerror="this.onerror=null;this.src='../assets/default_recipe.jpg';">
    <h1>Poha</h1>
    <h3>Ingredients:</h3>
    <p>flattened rice, onion, potato, spice</p>
    <h3>Steps:</h3>
    <ol style="text-align:left;max-width:380px;margin:0 auto 10px auto;padding-left:1.2em;">
        <li>Wash poha and drain water.</li>
        <li>Heat oil, add mustard seeds and curry leaves.</li>
        <li>Add onions, green chilies, and potatoes.</li>
        <li>Cook until potatoes soften.</li>
        <li>Add poha, turmeric, and salt.</li>
        <li>Mix gently and cook for 2 minutes.</li>
        <li>Garnish with coriander and lemon.</li>
        <li>Serve hot.</li>
    </ol>
    ...
    <a href="https://www.youtube.com/results?search_query=Poha+recipe" target="_blank" style="display:inline-block;margin-top:18px;padding:10px 22px;background:linear-gradient(90deg,#f76b1c,#fda085);color:#fff;border:none;border-radius:6px;font-size:1rem;font-weight:bold;text-decoration:none;box-shadow:0 2px 8px #fda08533;transition:background 0.2s,transform 0.2s;">▶ Watch on YouTube</a>
</div>
