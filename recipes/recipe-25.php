...
<div class="recipe-container">
    <img class="recipe-img" src="../images/dahi_puri.jpg" alt="Dahi Puri" onerror="this.onerror=null;this.src='../assets/default_recipe.jpg';">
    <h1>Dahi Puri</h1>
    <h3>Ingredients:</h3>
    <p>puri, curd, potato, chutneys</p>
    <h3>Steps:</h3>
    <ol style="text-align:left;max-width:380px;margin:0 auto 10px auto;padding-left:1.2em;">
        <li>Boil and mash potatoes.</li>
        <li>Crack puris gently.</li>
        <li>Stuff with potato filling.</li>
        <li>Add whisked curd on top.</li>
        <li>Drizzle green and tamarind chutneys.</li>
        <li>Sprinkle sev, coriander, and spices.</li>
        <li>Serve chilled.</li>
    </ol>
