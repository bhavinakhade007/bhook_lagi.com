...
<div class="recipe-container">
    <img class="recipe-img" src="../images/bhel_puri.jpg" alt="Bhel Puri" onerror="this.onerror=null;this.src='../assets/default_recipe.jpg';">
    <h1>Bhel Puri</h1>
    <h3>Ingredients:</h3>
    <p>puffed rice, onion, tomato, chutney</p>
    <h3>Steps:</h3>
    <ol style="text-align:left;max-width:380px;margin:0 auto 10px auto;padding-left:1.2em;">
        <li>Mix puffed rice, chopped onions, tomatoes, and boiled potatoes.</li>
        <li>Add green chutney, tamarind chutney, and spices.</li>
        <li>Mix quickly.</li>
        <li>Add sev and coriander.</li>
        <li>Serve immediately before puffed rice softens.</li>
    </ol>
